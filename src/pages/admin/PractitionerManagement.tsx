    ...
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <div className="bg-slate-900 border-b border-slate-800 px-6 py-4 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-50">從業人員管理</h1>
            <p className="text-sm text-slate-400 mt-1">管理老師、課程指派和休假時間</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition font-medium text-sm shadow-sm"
            >
        ...
        <div className="px-6 py-4 border-b border-slate-800 space-y-3">
          <div className="flex gap-3">
            ...
            <select
              ...
              className="px-3 py-2 text-sm border border-slate-700 bg-slate-800 rounded-lg text-slate-50 focus:outline-none focus:ring-2 focus:ring-green-500"
            >
