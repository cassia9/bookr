...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'none': 'none',
        'xs': '0 2px 4px 0 rgba(0, 0, 0, 0.06)',
        'sm': '0 4px 6px 0 rgba(0, 0, 0, 0.08), 0 2px 4px 0 rgba(0, 0, 0, 0.05)',
        'md': '0 8px 12px -2px rgba(0, 0, 0, 0.12), 0 4px 6px -1px rgba(0, 0, 0, 0.08)',
        'lg': '0 16px 24px -4px rgba(0, 0, 0, 0.15), 0 8px 12px -2px rgba(0, 0, 0, 0.08)',
        'xl': '0 24px 36px -8px rgba(0, 0, 0, 0.20), 0 12px 16px -4px rgba(0, 0, 0, 0.10)',
        '2xl': '0 32px 64px -16px rgba(0, 0, 0, 0.30)',
